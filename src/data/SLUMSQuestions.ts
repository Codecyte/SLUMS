...
export const SLUMSQuestions: Question[] = [
    ...
    answerChoices: [
        ...
        prompt: "Please remember these five objects: \n Apple, Pen, Tie, House, Car",
    }, {
        prompt: "You have $100 and you go to the store and buy a dozen apples for $3 and a tricycle for $20. \n \n How much did you spend?",
        answerChoices: [
            {
                answerText: "$23",
                pointWorth: 1
        ...
        prompt: "What were the 5 things I asked you? (1 for every correct answer) [Apple, Pen, Tie, House, Car]", 
        answerChoices: [
            {
        ...
        prompt: "I am going to give you a series of numbers and I would like you to give them to me backwards. For example, if I say 42, you would say 24. \n 87", 
        answerChoices: [
            {
                answerText: "Correct",
                pointWorth: 0
        ...
        prompt: "This is a clock face. Please put in the hour markers and the time at ten minutes to eleven o’clock.", 
        answerChoices: [
            {
                answerText: "",
                pointWorth: 0,
